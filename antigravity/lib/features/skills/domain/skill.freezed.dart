...
mixin _$Skill {
 ...
 String get id; String get name; SkillCategory get category; double get proficiency;// 0.0 to 1.0
 String? get iconUrl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,category,proficiency,iconUrl);

@override
String toString() {
  return 'Skill(id: $id, name: $name, category: $category, proficiency: $proficiency, iconUrl: $iconUrl)';
}
...
@useResult
$Res call({
 String id, String name, SkillCategory category, double proficiency, String? iconUrl
});
...
/// Create a copy of Skill
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? category = null,Object? proficiency = null,Object? iconUrl = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,category: null == category ? _self.category : category // ignore: cast_nullable_to_non_nullable
as SkillCategory,proficiency: null == proficiency ? _self.proficiency : proficiency // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  SkillCategory category,  double proficiency,  String? iconUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Skill() when $default != null:
return $default(_that.id,_that.name,_that.category,_that.proficiency,_that.iconUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  SkillCategory category,  double proficiency,  String? iconUrl)  $default,) {final _that = this;
switch (_that) {
case _Skill():
return $default(_that.id,_that.name,_that.category,_that.proficiency,_that.iconUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  SkillCategory category,  double proficiency,  String? iconUrl)?  $default,) {final _that = this;
switch (_that) {
case _Skill() when $default != null:
return $default(_that.id,_that.name,_that.category,_that.proficiency,_that.iconUrl);case _:
  return null;
...
class _Skill implements Skill {
  const _Skill({required this.id, required this.name, required this.category, required this.proficiency, this.iconUrl});
  factory _Skill.fromJson(Map<String, dynamic> json) => _$SkillFromJson(json);

@override final  String id;
@override final  String name;
@override final  SkillCategory category;
@override final  double proficiency;
// 0.0 to 1.0
...
/// Create a copy of Skill
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? category = null,Object? proficiency = null,Object? iconUrl = freezed,}) {
  return _then(_Skill(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,category: null == category ? _self.category : category // ignore: cast_nullable_to_non_nullable
